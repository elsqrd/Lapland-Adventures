            ...
            <div style={style_elList}>
              {items_list.map((row, index) => {
                let itemComp = (row._componentId)
                    ...
                    : <AdventureItem appActions={this.props.appActions} deviceInfo={this.props.deviceInfo} locStrings={this.props.locStrings} dataSheetId={'listData1'} dataSheetRow={row} {...{ 'title': row['title'], 'description': row['description'], 'picture': row['picture'], }} />;
